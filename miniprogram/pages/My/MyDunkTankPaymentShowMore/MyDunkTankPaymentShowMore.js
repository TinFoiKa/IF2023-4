// pages/My/MyDunkTankPaymentShowMore/MyDunkTankPaymentShowMore.js
const app = getApp()
...
Page({
    ...
    onShow() {
		...
		wx.cloud.callFunction({
			name : "executeSql",
			data : {
				sql : "select a.*, b.dunked_guy as guyName from eBRecord a inner join DunkTank b on a.booth_ID=b.dunk_ID where a.sender_open_id='"+this.data.openId+"' and a.type=3 and a.booth_type=2 and a.wechatPaymentState=1 order by a.datetime desc"
			},
			success : function(res){
				that.setData({
